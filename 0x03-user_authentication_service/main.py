...
def reset_password_token(email: str) -> str:
    """tests reset password token route handler
    """
    payload = {'email': email}
...
def update_password(email: str,
    ...
    """testsing  update a user password
    """
